...
function Footer() {
	return (
		<footer className="mt-auto flex w-full flex-col gap-[44px] bg-medinfo-primary px-6 py-10 text-white lg:flex-row lg:items-start lg:justify-between lg:px-[102px] lg:py-[56px]">
